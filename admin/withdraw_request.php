...
if($_SESSION['username'])
{
	...
	$fetch2 = mysqli_query($con,"SELECT * FROM member WHERE username='$user'");
	$fetch = mysqli_num_rows($fetch2);
	$fetch = mysqli_fetch_assoc($fetch2);
...
<head lang="en">
	...
	<title>Twitouch | Withdraw Requests</title>
				...
				<div class="row">
					...
					<table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tr>
							...
							<th>Amount</th>
							<th>Message</th>
							<th>Activation Control</th>
						</tr>
						</thead>
						<tbody>
							<?php include "inc/withdraw_request.php";?>
