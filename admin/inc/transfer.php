	...
	if(isset($_POST['submit']))
	{
		...
		if($match == 1)
		{
			if($current > $amount)
			{
				...
				$update1 = $con->query("INSERT INTO transfer_history(member_id,reciever_id,amount,message,transfer_date,status)VALUES('$member_id','$reciever_id','$amount','$message','$date','$status')") or die($con->errno);
