	    ...
	    <ul class="side-menu-list">
			...
			<a href="home.php">
	            <span>
	                ...
	                <span class="lbl">Member Dashboard</span>
	            </span>
			</a>
	        </li>
			...
			<li class="yellow with-sub">
	            ...
	            <ul>
	                <li><a href="jobs.php"><span class="lbl">New Jobs</span></a></li>
	                <li><a href="job_history.php"><span class="lbl">Job Earn History</span></a></li>
	            </ul>
	        </li>
